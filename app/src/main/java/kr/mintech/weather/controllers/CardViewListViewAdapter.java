...
public class CardViewListViewAdapter extends RecyclerView.Adapter<CardViewListViewAdapter.ViewHolder>
{
  private ArrayList<ListViewItem> listViewItemList;
  private ListViewItem listViewItemList1;
  private Context context;

  public CardViewListViewAdapter(ArrayList<ListViewItem> listViewItemList)
  {
  ...
  @Override
  public CardViewListViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
  {
